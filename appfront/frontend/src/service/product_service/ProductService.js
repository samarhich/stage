...
export default 
{
    ...
    AddProduct(product){
        ...
        let data=new FormData();  // ki yebda fama image nkhdem form data 
    ...
    return axios.post(`/UpdateProduit/${id}`,data,config)// normalmnt put ama khater form data nkhdemoha post
   },
